...
{
    public class AdventOfCodeTwentyTwoOperation : Operation
    {
        private readonly AdventOfCodeTwentyTwoCommandLineOptions _options;

        public AdventOfCodeTwentyTwoOperation(AdventOfCodeTwentyTwoCommandLineOptions options)
        {
            _options = options;
        }
        ...
        public override void Execute()
        {
            ...
            string filename = Path.Combine(Environment.CurrentDirectory, "..", "AdventOfCode.2022", "input", $"day{_options.Day.ToString("D2")}{sample}.txt");
