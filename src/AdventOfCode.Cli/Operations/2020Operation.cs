...
{
    public class AdventOfCodeTwentyOperation : Operation
    {
        private readonly AdventOfCodeTwentyCommandLineOptions _options;

        public AdventOfCodeTwentyOperation(AdventOfCodeTwentyCommandLineOptions options)
        {
            _options = options;
        }
        ...
        public override void Execute()
        {
            ...
            string filename = Path.Combine(Environment.CurrentDirectory, "..", "AdventOfCode.2020", "input", $"day{_options.Day.ToString("D2")}{sample}.txt");
